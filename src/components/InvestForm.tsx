        ...
        <>
          <div>
            ...
            <p className="text-[10px] text-on-surface-variant mt-1">
              = {tokens} tokens ({tokenPrice > 0 ? ((tokens / (fundingGoal / tokenPrice)) * 100).toFixed(2) : "0.00"}% equity)
            </p>
          </div>
          {error && (
            ...
            <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
              <div className="bg-surface-container-lowest border border-outline-variant/20 rounded-xl p-6 max-w-md w-full space-y-5 my-auto max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-2 text-sm text-on-surface-variant">
                  ...
                  <p>Equity: <span className="text-on-surface font-bold">{tokenPrice > 0 ? ((tokens / (fundingGoal / tokenPrice)) * 100).toFixed(2) : "0.00"}%</span></p>
                </div>
