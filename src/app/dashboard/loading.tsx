      ...
      <div className="animate-pulse space-y-8">
        <div className="flex justify-between items-end">
          <div>
            ...
            <div className="h-10 w-64 bg-surface-container rounded" />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[1,2,3,4].map(i => (
            <div key={i} className="glass-panel rounded-xl p-6 h-36">
              <div className="h-2 w-24 bg-surface-container-high rounded mb-4" />
              <div className="h-8 w-32 bg-surface-container-high rounded mt-8" />
            </div>
          ))}
        </div>
        <div className="glass-panel rounded-xl p-8 h-80">
          <div className="h-4 w-40 bg-surface-container-high rounded mb-6" />
          <div className="h-60 bg-surface-container rounded" />
        </div>
