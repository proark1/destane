    ...
    <div className="min-h-screen bg-surface-container-lowest text-on-surface">
      ...
      <section className="border-y border-outline-variant/10 py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-wrap justify-center gap-8 md:gap-16">
          {[
            { value: "$24M+", label: "Total Invested" },
            { value: "12,400+", label: "Active Investors" },
            { value: "47", label: "Productions Funded" },
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-3 flex items-center justify-between text-xs text-on-surface-variant">
                  <span>Target: {prod.target}</span>
                  <span className="text-primary font-bold">{prod.funded}% funded</span>
                </div>
